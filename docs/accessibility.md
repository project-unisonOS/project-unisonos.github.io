...
you and your situation: text, speech, visual interaction, touch, keyboard,
...
A capability is not complete if you can start it with a modality but cannot
understand its disclosure, confirm it, cancel it, recover from an error, or
review the outcome through that modality. Automated WCAG checks are a baseline; testing
