...
<div class="story-grid boundary-grid">
  ...
  <section><h3>Subdomain</h3><p>A named area within an existing context can carry more specific organization and policy while inheriting its parent security controls.</p></section>
...
<aside class="evidence-band" aria-label="Taxonomy evolution evidence">
