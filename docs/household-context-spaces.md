...
## Phase 2 review candidate

The current candidate implements these rules in a versioned contract and durable
...
semantic status region. The candidate is awaiting its final Phase 2 gate and is
