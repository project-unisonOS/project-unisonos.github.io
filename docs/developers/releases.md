...
is the current downloadable software preview.
...
- **Architecture:** x86-64
- **Status:** unsupported, pre-production software preview
- **Hardware:** physical appliance validation is still pending
- **Intended use:** testing the release, verification, installer, and update workflows
