...
- [unison-hardware](https://github.com/project-unisonOS/unison-hardware): system requirements, hardware interfaces, BOM data, open design sources, and qualification plans ([unison-hardware README](https://github.com/project-unisonOS/unison-hardware/blob/main/README.md))
- [unison-infrastructure](https://github.com/project-unisonOS/unison-infrastructure): reproducible development, lab, deployment, and hardware-in-the-loop profiles ([unison-infrastructure README](https://github.com/project-unisonOS/unison-infrastructure/blob/main/README.md))
