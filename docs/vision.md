...
- Useful autonomy grows only with demonstrated safety, inspectability, and control.
- Leaving must be possible through per-person export, deletion, backup, and restore.

UnisonOS names the appliance runtime and operating surface. Unison names the
assistant platform and experience. Neither is positioned as a general-purpose
operating system or smartphone replacement.
